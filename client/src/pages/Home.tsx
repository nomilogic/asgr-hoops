          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto mt-4">
                ASGR-ranked players have committed to the nation's top
                basketball programs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-6">
                <div className="bg-card border border-border rounded-xl p-8 hover-elevate">
                  <h3 className="text-2xl md:text-3xl font-bold mb-6 leading-tight">
                    ASGR Basketball is a customized version recruiting service
                    specifically built for All Star Girls Report.
                  </h3>
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      The unequaled, in-depth player evaluations from the All
                      Star Girls Report produced by longtime analyst Michael T.
                      White will evaluate over 2,500 prospects at the High
                      School, Transfer Portal, Juco 150, International and
                      Middle School levels each year.
                    </p>
                    <p>
                      The service that revolutionized women's basketball over
                      the past several decades simply gets better and better.
                      Beginning June 1, 2025 through May 31, 2026, get our ASGR
                      database Today!
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-card border border-border rounded-xl p-8 hover-elevate">
                <h4 className="text-xl font-bold mb-4 text-red-500">
                  Exclusive ASGR Database Features
                </h4>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Access our unequaled, in-depth scouting data. The database
                    allows your staff to stay up-to-date with our inside
                    information on national evaluations, player ratings and
                    rankings, key interviews of prospects around the country.
                  </p>
                  <p>
                    All the latest projections from the recruiting trail will be
                    available with consistent reports on the ASGR database from
                    major non and live viewing period events. Find all the
                    recruiting needs with one, quick mobile stop.
                  </p>
                  <p>
                    The ASGR database can give daily and weekly updates on
                    current prospects that best fit your college system.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-lg font-semibold">
                      Future WNBA draft pick | WNBA Draft Projection
                    </p>
                    <img
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-lg font-semibold text-muted-foreground">
                      High Major Starter That can be an impact Player at:
                    </p>
                    <img
              ...
              <div className="bg-card border-2 border-border rounded-xl p-8 hover-elevate transition-all duration-300">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-lg font-semibold text-muted-foreground">
                      Mid Major Starter That can be an impact Player at:
                    </p>
                    <img
              ...
              <div className="bg-card border-2 border-border rounded-xl p-8 hover-elevate transition-all duration-300">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <p className="text-lg font-semibold text-muted-foreground">
                      Division 2 or 3 Starter or Role Player
                    </p>
                    <img
