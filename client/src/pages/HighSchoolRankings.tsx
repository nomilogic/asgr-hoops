                  ...
                  >
                    <div className="grid grid-cols-12 gap-4 p-6 items-center">
                      ...
                      <div className="col-span-4 flex items-center gap-3">
                        {ranking.logoPath ? (
                          <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center p-2 border-2 border-red-500/50 shadow-lg shadow-red-500/30">
                            <img
                          ...
                          <div className="w-20 h-20 rounded-full bg-muted/50 border-2 border-red-500/50 shadow-lg shadow-red-500/30 flex items-center justify-center">
